...
public class SearchSuggestionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<JsonObject> mSearchSuggestions = new ArrayList<>();
    ...
    public interface OnBindSuggestionCallback {
        ...
        void onBindSuggestion(View suggestionView, ImageView rightIcon, boolean showRightIcon, TextView textView,
                              JsonObject item, int itemPosition);
        String getValue(JsonObject jsonObject);
    }
    ...
    public interface Listener {
        ...
        void onItemSelected(JsonObject item);

        void onMoveItemToSearchClicked(JsonObject item);
    }
    ...
    public void swapData(List<JsonObject> searchSuggestions) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        ...
        JsonObject suggestionItem = mSearchSuggestions.get(position);

        if (mOnBindSuggestionCallback != null) {
            mOnBindSuggestionCallback.onBindSuggestion(viewHolder.itemView,  viewHolder.rightIcon, mShowRightMoveUpBtn, viewHolder.body,
                    suggestionItem, position);
            viewHolder.body.setText(mOnBindSuggestionCallback.getValue(suggestionItem));
        }
    }
